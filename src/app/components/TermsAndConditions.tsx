            ...
            <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
              ...
              <section>
                ...
                <p className="text-justify mb-4">
                  Настоящите „Общи условия" регулират взаимоотношенията между фирма "Ю Транс" Еоод и потребителите на електронната (интернет) страница и услуги, предоставяни чрез домейна www.parkingone.bg. Фирмата "Ю Транс" Еоод е собственик на уебсайта и осигурява услугите, свързани с паркирането на паркинг до летище София. Всеки потребител, който използва нашия уебсайт www.parkingone.bg, е задължен да спазва настоящите общи условия през целия период на ползването – от момента на достъпване на сайта до напускането му.
                </p>
                <p className="text-justify mb-4">
                  Тези условия са задължителни както за фирмата "Ю Транс" Еоод така и за всички потребители, които маркират обектите, линковете или бутоните на страниците на www.parkingone.bg/ (с изключение на линка към настоящите „Общи условия") или използват услугите, предлагани от паркинга, намиращ се на адрес гр. София.
                </p>
                <p className="text-justify mb-4">
                  Тук се съдържат Общите условия, съгласно които "Ю Транс" Еоод предоставя продукти и услуги на потребителите си, посредством уебсайта https://www.parkingone.bg/. Тези условия обвързват всички потребители и уреждат правилата за използването на уебсайта https://www.parkingone.bg/, включително сключването на договори за паркинг услуги.
                </p>
                <p className="text-justify mb-4">
                ...
                <p className="text-justify">
                  Фирмата "Ю Транс" Еоод препоръчва внимателно да прочетете Общите условия, преди да използвате нашия уебсайт. Ако не приемате тези Общи условия, не трябва да използвате https://www.parkingone.bg/.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-3 text-justify">
                  <li><strong>ПРОДАВАЧ</strong> – "Ю Транс" Еоод включително https://www.parkingone.bg/ или всеки партньор на "Ю Транс" Еоод свързан с уебсайта https://www.parkingone.bg/</li>
                  ...
                  <li><strong>РЕЗЕРВАЦИЯ</strong> – представлява индивидуална заявка за закупуване на избраните „Услуги", съгласно условията, определени на уебсайта. Това е акт, извършен от потребителя по своя собствена преценка и го обвързва със силата на договор между потребителя и фирмата „Ю Транс" Еоод.</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-justify mb-4">
                  4.3. Общите условия могат да бъдат едностранно променяни от "Ю Транс" Еоод по всяко време, чрез актуализацията им. Тези промени влизат в сила незабавно след публикуването им на сайта и са задължителни за всички потребители.
                </p>
                
                <p className="text-justify mb-4">
                  4.4. www.parkingone.bg/ има правото по всяко време и без предупреждение да извършва промени в публикуваните материали, услуги и цени. Някои от публикуваните материали могат да бъдат остарели, и "Ю Транс" Еоод не носи отговорност за тяхната актуализация.
                </p>
                
                <p className="text-justify">
                  4.7. "Ю Транс" Еоод има правото да променя цените по свое усмотрение, по всяко време и без предварително уведомление на потребителите.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-justify mb-4">
                  5.1. Фирмата "Ю Транс" Еоод се ангажира при възможност и наличност на места да осигури паркомясто за лек автомобил на всеки свой клиент, който направи резервация посредством сайта www.parkingone.bg/
                </p>
                
                <p className="text-justify mb-4">
                  5.2. Служителите на фирмата "Ю Транс" Еоод имат право да откажат приемането на МПС (моторно превозно средство) на паркинга в следните случаи:
                </p>
                ...
                <p className="text-justify pl-6 mb-4">
                  5.2.2. При преценка от страна на служителите на фирмата "Ю Транс" Еоод за потенциално вредоносна ситуация от всякакъв характер.
                </p>
                
                <p className="text-justify mb-4">
                  5.3. При използване на услугите на фирмата "Ю Транс" Еоод клиентът потвърждава, че е собственик на МПС (или че е упълномощен от собственика да го използва) и че МПС-то е в добро техническо състояние (с преминал технически преглед), застраховано съгласно всички приложими законови изисквания и разполага с регистрационен талон.
                </p>
                
                <p className="text-justify mb-4">
                  5.4. Ако резервацията е н��правена от трета страна, тя носи отговорността за договорните задължения на клиента. Третата страна може да има предимство пред клиента само ако фирмата "Ю Транс" Еоод приеме това.
                </p>
                
                <p className="text-justify mb-4">
                  5.5. Сумите заплатени за резервации не са възвращаеми за всички клиенти на фирмата „Ю Транс" Еоод. Не се таксува допълнителна такса в случай на непоявяване на клиент, след като е направена резервация. Фирмата "Ю Транс" Еоод запазва правото да не прави резервации за клиенти според своята преценка.
                </p>
                
                <p className="text-justify pl-6 mb-4">
                  5.5.1. След изтичане на резервирания период, клиентът дължи наем за времето от изтичане на договорения период до получаване на автомобила, в съответствие с посочените в сайта тарифи за паркинг. За автомобили, които не са били иззети в рамките на 30 дни след изтичане на резервирания период, фирмата "Ю Транс" Еоод си запазва правото да потърси помощ от МВР и съответните държавни органи.
                </p>
                
                <p className="text-justify pl-6 mb-4">
                  5.5.2. При желание за престой, продължаващ повече от 3 месеца, клиентът трябва да уведоми служителите на фирмата „Ю Транс" Еоод.
                </p>
                
                <p className="text-justify mb-4">
                  5.6. Фирмата "Ю Транс" Еоод не носи отговорност за вреди, причинени от трети страни или от други клиенти на компанията, но предоставя наличната информация под формата на показания и видеозаписи на пострадалите страни. Фирмата "Ю Транс" Еоод не носи отговорност в случай на вреди, ПТП (пътно-транспортно произшествие) или кражба на МПС или на вещи от него.
                </p>
                
                <p className="text-justify mb-4">
                  5.7. Цените на предлаганите услуги от фирмата "Ю Транс" Еоод са обявени на уебсайта на компанията в български лева и евро. Плащането се извършва чрез банков превод, плащане с карта или на място с карта или в брой само в български лева или евро.
                </p>
              ...
              <section>
                ...
                <p className="text-justify mb-4">
                  7.1. С изключение на случаите, когато е посочено друго, "Ю Транс" Еоод не носи отговорност за невъзможността да изпълни задълженията си, частично или изцяло, ако такава невъзможност е предизвикана от непреодолима сила.
                </p>
                
                <p className="text-justify mb-4">
                  7.2. Ако "Ю Транс" Еоод се позовава на непреодолима сила, трябва незабавно и изчерпателно да уведоми другата страна за настъпилото събитие и да предприеме необходимите мерки за ограничаване на последиците от него.
                </p>
                
                <p className="text-justify mb-4">
                  7.3. Ако "Ю Транс" Еоод се позовава на такова събитие, се освобождава от отговорност само ако това събитие прави невъзможно добросъвестното изпълнение на договора.
                </p>
              ...
              <section>
                ...
                <p className="text-justify mb-4">
                  8.1. Резервацията на паркинг услуги през уебсайта https://www.parkingone.bg/ се осъществява чрез попълване на съответната форма за резервация и последващо потвърждение от страна на "Ю Транс" Еоод или нейния представител. Резервацията е предварителна и подлежи на наличността на свободни места за паркиране.
                </p>
                
                <p className="text-justify mb-4">
                  8.2. Потребителят е отговорен за предоставянето на точни и пълни данни при резервацията, включително данни за контакт и информация за превозното средство. "Ю Транс" Еоод не носи отговорност за грешки или непълности във въведените от потребителя данни.
                </p>
                
                <p className="text-justify mb-4">
                  8.3. Резервацията се счита за приета и валидна след получаване на потвърждение от страна на "Ю Транс" Еоод или нейния представител. В случай на промяна или отмяна на резервацията, потребителят трябва да се свърже с "Ю Транс" Еоод в съответните срокове и спазвайки условията, определени от фирмата.
                </p>
                
                <p className="text-justify">
                  8.4. Моля, имайте предвид, че резервацията не гарантира наличност на паркинг място в случаи на непредвидени обстоятелства или препълненост на капацитета. "Ю Транс" Еоод си запазва правото да откаже или промени резервацията в случай на форсмажорни обстоятелства или по свое усмотрение.
                </p>
              </section>
