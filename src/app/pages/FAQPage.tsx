    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="pt-24 md:pt-32 pb-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Contact CTA */}
          <div className="mt-12 bg-[#FAF9F6] rounded-xl p-8 text-center text-[#0073AC]">
            <h3 className="text-2xl font-bold mb-3">
              {t('faqStillHaveQuestions')}
            </h3>
            <p className="text-[#0073AC]/90 mb-6">
              {t('faqContactDesc')}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button
                onClick={() => navigate('/contact')}
                className="bg-white/10 text-[#0073AC] px-6 py-3 rounded-full font-semibold hover:bg-white/20 transition-colors border border-white/30"
              >
                {t('faqGoToContact')}
              </button>
            </div>
      ...
      {/* Footer */}
      <footer className="text-[#0073AC] py-12 bg-[#FAF9F6]">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex gap-4 justify-center items-center mt-6">
            ...
            <a
              ...
              aria-label="WhatsApp"
            >
              <svg className="w-6 h-6 text-[#0073AC]" fill="currentColor" viewBox="0 0 24 24">
